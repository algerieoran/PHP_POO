...
/*
Lorsqu'on utilise spl_autoload_register en POO, on doit lui fournir le nom de la classe et la méthode (OBLIGATOIREMENT static) à exécuter.  //+pour moi :  "(static=elle change pas elle appartient à la class)".
*/