...
use PDO; // On récup7RE la classe PDO qui existe dans l'espace GLOBAL  de php, afin de pouvoir l'utiliser dans le namespace actuel (Manager) 
...
class PDOManager
{
    ...
    private function __construst () {}  // En private, on ne peut plus instancier la classe  
